...
makeBGPUpdate nlri withdrawn attributes = parseUpdate $ BGPUpdate {withdraw = withdrawn, attributes = attributes, nlris = nlri}

{-# INLINE parseUpdate #-}
parseUpdate :: BGPMessage -> ParsedUpdate
parseUpdate BGPUpdate {..} = ParsedUpdate {puPathAttributes = attributes, nlri = nlris, withdrawn = withdraw, hash = pathHash attributes}
