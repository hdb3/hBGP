module BGPlib.Codes where

import BGPlib.LibCommon
import Data.Bits
import Data.Word

data PathAttributeTypeCode
  = TypeCodePathAttributeOrigin
  | TypeCodePathAttributeASPath
  | TypeCodePathAttributeNextHop
  | TypeCodePathAttributeMultiExitDisc
  | TypeCodePathAttributeLocalPref
  | TypeCodePathAttributeAtomicAggregate
  | TypeCodePathAttributeAggregator
  | TypeCodePathAttributeCommunities
  | TypeCodePathAttributeMPREachNLRI
  | TypeCodePathAttributeMPUnreachNLRI
  | TypeCodePathAttributeExtendedCommunities
  | TypeCodePathAttributeAS4Path
  | TypeCodePathAttributeAS4Aggregator
  | TypeCodePathAttributeConnector
  | TypeCodePathAttributeASPathlimit
  | TypeCodePathAttributeLargeCommunity
  | TypeCodePathAttributeAttrSet
  | TypeCodePathAttributeUnknown
  deriving (Show, Eq, Ord)

allPathAttributeTypeCodes =
  [ TypeCodePathAttributeOrigin,
    TypeCodePathAttributeASPath,
    TypeCodePathAttributeNextHop,
    TypeCodePathAttributeMultiExitDisc,
...
flagsOf e
  | e == TypeCodePathAttributeOrigin = transitive
...
instance Enum PathAttributeTypeCode where
  toEnum n
    | n == 1 = TypeCodePathAttributeOrigin
  ...
  fromEnum e
    | e == TypeCodePathAttributeOrigin = 1
...
instance EnumWord8 ASSegmentElementTypeCode
