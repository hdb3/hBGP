...
updateTest = do
  ...
  let pt = newPrefixTable
      rib =
        (update_ ["192.168.1.0/24"] route11) $
...
withdrawTest = do
  putStrLn "\nWithdraw test\n"
  let (pt0, _) = PrefixTable.update newPrefixTable l1 route11
...
selectTest1 = do
  putStrLn "\nselectTest1\n"
  let (pt0, _) = PrefixTable.update newPrefixTable l0 route11
...
selectTest2 = do
  putStrLn "\nselectTest2\n"
  let (pt0, _) = PrefixTable.update newPrefixTable l0 route12
...
selectTestN = do
  putStrLn "\nselectTestN\n"
  let (pt0, _) = PrefixTable.update newPrefixTable l1 route12
