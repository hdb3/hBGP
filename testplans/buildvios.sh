...
virt-install --os-variant freebsd12.0 --noautoconsole --import --disk br1.qcow2 --name br1 --memory 2048 --network network=default1,model=e1000 --network network=default2,model=e1000 --network network=default2,model=e1000 --network network=default2,model=e1000
